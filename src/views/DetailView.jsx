    ...
    <div>
      ...
      <div className="row">
        ...
        <section className="col-md-9 d-flex flex-column gap-5 p-md-4">
          <Line data={modal.chartData} />
          <Bar data={modal.chartData} />
        </section>
      </div>
    </div>
  );
